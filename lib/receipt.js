...
6. CARD: extract the last 4 digits of the card used (from "Acct #", "MASTERCARD", "VISA", "****3612", etc.) as "cardLast4". If it was cash (or no card number is shown), set it to null.
...
Return ONLY this JSON (no prose):
{
  ...
  "date": "YYYY-MM-DD",
  "total": number,
  "account": "Cash" or null,           // only if handwriting says cash; otherwise null
  "cardLast4": "1234" or null,         // last 4 of the card on the receipt
  "needsSplit": boolean,
